...
public class MyTool {
    ...
    public static void startPicker(Activity context,boolean showGif,int photoCount,ArrayList<String> photos){
        PhotoPickUtils.startPick(context,showGif,photoCount,photos);
    }
            ...
            luban.setCompressFileRenameMethod(builder.renameable);
                ...
                .subscribe(new Consumer<List<File>>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        ...
                        builder.callback.onFail(throwable.getMessage(),throwable);
                    }
                });
